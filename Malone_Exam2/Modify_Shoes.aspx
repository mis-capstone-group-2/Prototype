<%@ Page Title="" Language="VB" MasterPageFile="~/MasterP.master" AutoEventWireup="false" CodeFile="Modify_Shoes.aspx.vb" Inherits="Modify_Shoes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Prod_Desc" DataValueField="Prod_Desc"></asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Prod_Desc] FROM [Clothing]"></asp:SqlDataSource>
    <br /><br />
    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="Prod_ID" DataSourceID="SqlDataSource2">
        <Fields>
